...
export const metadata: Metadata = {
  ...
  description: "How Radious collects, uses and protects your data.",
  ...
  return (
    <LegalShell title="Privacy Policy" updated="July 12, 2026">
      ...
      <ul>
        ...
        <li>
          <strong>YouTube Music (optional):</strong> read-only access to your
          playlists so the station can play them.
        </li>
        <li>
      ...
      <p>
        ...
        agreements: authentication (Clerk), script generation (Anthropic Claude),
        voice synthesis (Fish Audio, ElevenLabs), call transcription (ElevenLabs
        Scribe), music catalogs (Audius, Jamendo), Google APIs for Calendar and
        YouTube Music (read-only, per Google&rsquo;s API Services User Data Policy),
        weather data (WeatherAPI) and cloud hosting. Each receives only what it
      ...
      <p>
        ...
        integrations (location, calendar, YouTube) at any time in the app. You can
        also lodge a complaint with the Estonian Data Protection Inspectorate
